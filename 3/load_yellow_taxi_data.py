...
BUCKET_NAME = "dezoomcamp_hw3_2025"#"kestra-bucket-es-30-1"# 

# If you authenticated through the GCP SDK you can comment out these two lines
CREDENTIALS_FILE = "E:\\data_zoomcamp\\3\\gcs.json"
client = storage.Client.from_service_account_json(CREDENTIALS_FILE)
# If commented initialize client with the following
#client = storage.Client(project='kestra-sandbox-485912')  # Replace with your project ID
...
def create_bucket(bucket_name):        
    try:          
        # Get bucket details
        bucket = client.get_bucket(bucket_name, timeout=10)
